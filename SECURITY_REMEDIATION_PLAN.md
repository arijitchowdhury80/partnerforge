# PartnerForge Security Remediation Plan
...
**Rationale:**
- PartnerForge is an internal sales tool, not a multi-tenant SaaS
...
| JSearch (RapidAPI) | https://rapidapi.com/developer/dashboard | Apps → PartnerForge → Regenerate Key |
...
2. **Add development origins via environment:**
   ```
   CORS_ORIGINS=http://localhost:5173,http://localhost:3000,https://partnerforge.vercel.app
   ```
