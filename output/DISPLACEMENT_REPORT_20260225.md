# PartnerForge Displacement Report
...
PartnerForge analyzed **2,700 companies** using Adobe Experience Manager that are **NOT** currently using Algolia. These represent displacement opportunities for Algolia's sales team.
...
*Report generated by PartnerForge v1.0*
*Database: partnerforge.db (1.4MB)*
